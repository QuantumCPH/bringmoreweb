...
//            });
        ...
        messages: {
            ...
            email: {
                required: "<i class='fa fa-exclamation-triangle'></i>Please enter an email address",
                email: "<i class='fa fa-exclamation-triangle'></i>Please enter a valid email address."
            },
			os1: {
                required: "<i class='fa fa-exclamation-triangle os-err'></i>Please select OS"
            },
...
submitHandler: function(form) {
	$(form).ajaxSubmit({
		...
		success: function() {
		 var message ="You are subscribed successfully";
		...
		//	var message ="We are not able to subscribe you at this time";
...
*/
    ...
    $('#contact-form').validate({
        ...
        messages: {
            ...
            message: "<i class='fa fa-exclamation-triangle'></i>The message should contain minimum 10 characters."
        },
        submitHandler: function(form) {
            $(form).ajaxSubmit({
                type: "POST",
