<?php
 ...
 //    $to = "ok@zap-itsolutions.com"; //Change email here
  echo  $to = "riaz_qadeer90@yahoo.com"; //Change email here
...
$body .= "<tr style='background: #eee;'><td><strong>Name:</strong> </td><td>" . strip_tags($_REQUEST['name']) . "</td></tr>";
$body .= "<tr><td><strong>Email:</strong> </td><td>" . strip_tags($_REQUEST['email']) . "</td></tr>";
